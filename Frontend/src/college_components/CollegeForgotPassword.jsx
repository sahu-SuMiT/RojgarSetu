...
const CollegeForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/auth/college/forgot-password`, { email });
      ...
      <div className="max-w-md w-full space-y-8 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg px-8 py-10">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-base">
            No problem. Enter your college email address and we'll send you a link to reset your password.
          </p>
        </div>
...
export default CollegeForgotPassword; 