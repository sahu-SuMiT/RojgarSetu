...
import { FaUniversity, FaEye, FaEyeSlash, FaArrowLeft } from 'react-icons/fa';
...
const CollegeResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/auth/college/reset-password/${token}`, { password });
      ...
      <div className="max-w-md w-full space-y-8 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg px-8 py-10">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-base">
            Choose a new password for your college account.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-semibold rounded-md text-white bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              {loading ? (
        ...
        {showRedirectMessage && (
          <div className="rounded-md p-4 bg-orange-50 border border-orange-200">
            <div className="flex">
              <div className="flex-shrink-0">
              ...
              <div className="ml-3">
                <p className="text-sm text-orange-800">Redirecting to login page...</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center text-sm font-medium text-orange-600 hover:text-orange-500 focus:outline-none transition-colors duration-300"
          >
            <FaArrowLeft className="mr-2 h-4 w-4" />
