          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Roll Number', field: 'rollNumber', icon: '🔢' },
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Department', field: 'department', icon: '🏢' },
                { label: 'Batch', field: 'batch', icon: '🎒' },
                { label: 'Joining Year', field: 'joiningYear', icon: '🔰' },
                { label: 'Graduation Year', field: 'graduationYear', icon: '🎓' },
                { label: 'Year', field: 'year', icon: '📖' },
                { label: 'GPA', field: 'gpa', icon: '📊' },
                { label: 'CGPA', field: 'cgpa', icon: '📈' },
                ...
                <div key={field} className="group">
                  ...
                  {isEditing ? (
                    <input
                      type={typeof profileData[field] === "number" ? "number" : "text"}
                      value={profileData[field] || ''}
                      onChange={(e) => handleInputChange(field, e.target.value)}
                      className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200 hover:border-gray-400"
                      placeholder={`Enter ${label.toLowerCase()}`}
