...
const { addStudent, addCollege, addCompany,getCollegesBySales,getStudentsBySales, getCompaniesBySales, getSupportTicketsBySales} = require('../controllers/sales/salesController');
